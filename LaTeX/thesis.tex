...
% VERSION 1.5 (December 2019)
% Use pdfLaTeX (other possible, but not supported)
% Contact at KOM: Julian Zobel (julian.zobel@...)
%======================================================
% READ THE README FIRST!
%======================================================
\documentclass[longdoc,accentcolor=tud1b,11pt,paper=a4]{tuddesign/tudreport}
%======================================================
...
\newcommand{\komTitle}{Application of the Lottery Ticket Hypothesis in NLP and Early Pruning\xspace} 
% Translation of the title in either DE or EN, depending on thesis language
\newcommand{\komTitleTranslation}{Anwendung der "Lottery Ticket"-Hypothese in NLP und frühem Pruning\xspace}
...
\newcommand{\komSubmissionDate}{20. Januar 2020\xspace}% use only this date format

\newcommand{\komGutachter}{Gutachter: Prof.Dr.-Ing. Ralf Steinmetz\xspace}
\newcommand{\komBetreuer}{Betreuer/in: Anna Filighera, Tim Steuer\xspace}
\newcommand{\komExternerBetreuer}{}
\newcommand{\komID}{KOM-type-number KOM-B-0666\xspace}
...
\begin{document}
	...
	\bibliography{bibliography, images} % file name of your bib
